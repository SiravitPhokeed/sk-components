...
If you are still using Tailwind CSS v3, you can integrate it with SK Components
to use utility classes in your project. If you are using v4, please refer to
[this guide](/docs/guides/tailwindcss-v4).
...
>
> <Actions align="left" className="mb-3 mt-5"><Button children="Upgrade to Tailwind CSS v4" appearance="filled" href="https://tailwindcss.com/docs/upgrade-guide" /></Actions>
...
const config: Config = {
  ...
  plugins: [
    function ({ addVariant }) {
      addVariant("state-layer", ["&::before", ".skc-interactive__ripple"]);
    },
  ],
};
```
