...
<DemoCard
  ...
  initialProps={{
    children: [
      <MenuItem key="public" value="public">Public school</MenuItem>,
      <MenuItem key="private" value="private">Private school</MenuItem>,
      <MenuItem key="international" value="international">International school</MenuItem>,
    ],
    appearance: "outlined",
    label: "School type",
    className: "w-64",
