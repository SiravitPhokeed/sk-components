...
/**
 * The placeholder shown when Avatar has no image or initials.
 *
 * @private
 */
export const AvatarPlaceholder: StyleableFC = ({ className, style }) => (
  <svg
    viewBox="0 0 40 40"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    role="presentation"
    className={cn(`skc-avatar__placeholder`, className)}
    style={style}
  >
    <path
      fillRule="evenodd"
